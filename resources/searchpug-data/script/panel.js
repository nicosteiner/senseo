...
WatchPug.Panel = {
  ...
  generateInspectResultMarkup: function(id, grade, titleStrBundleKey, found, infoUrl, data) {
    ...
    var html =
      ...
      ' </div>' + 
      ' <div class="details">' + 
      '   <a href="' + infoUrl + '">' + WatchPug.StrBundle.getString(titleStrBundleKey) + ' [' + WatchPug.StrBundle.getString('al.tt.MoreInfo') + ']</a>' +
        notFound +
      '   <ul>' + 
        criteriaList +
      '   </ul>' + 
  ...
  showInspectResult: function() {
    ...
    inspectResultsContainer.html(
      ...
      WatchPug.Panel.generateInspectResultMarkup('host', WatchPug.Panel.grade['host'][0], 'al.tt.Domain', 'http://sensational-seo.com/on-page-criteria.html#domain', true, {
