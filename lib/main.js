...
WatchPug.AddonPanel = panel.Panel({
  ...
  onShow: function() {
    ...
    WatchPug.AddonPanel.port.on('getResponseText', function handleGetResponseTextEvent(key, url) {
      
      WatchPug.AddonPanel.getResponseText(key, url);
      
    });
  
    WatchPug.AddonPanel.activeTabWorker.port.on('getResponseText', function handleGetResponseTextEvent(key, url) {
